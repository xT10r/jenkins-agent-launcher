...
def _parse_args():
    ...
    parser.add_argument("--jnlp", action="store_true")
    parser.add_argument("--jnlp-url")
    parser.add_argument("--jnlp-refresh-secret", action="store_true")
    parser.add_argument("--jnlp-save-secret", action="store_true")
